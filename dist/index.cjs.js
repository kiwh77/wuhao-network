    ...
    function BaseProcessor() {
        ...
        this.handle = function (ctx, env) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                var middlewares, beforeName, beforeMiddlewares, globalBeforeMiddlewares, result, afterName, afterMiddlewares, globalAfterMiddlewares;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            globalBeforeMiddlewares = env.middleware.getGlobal(beforeName);
                            if (!(beforeMiddlewares.length > 0 || globalBeforeMiddlewares.length > 0)) return [3 /*break*/, 2];
                            return [4 /*yield*/, env.pipe.exec(__spreadArray(__spreadArray([], globalBeforeMiddlewares, true), beforeMiddlewares, true), ctx, env)];
                        case 1:
                            _b.sent();
                            _b.label = 2;
                        ...
                        case 3:
                            ...
                            globalAfterMiddlewares = env.middleware.getGlobal(afterName);
                            if (!(afterMiddlewares.length > 0 || globalAfterMiddlewares.length > 0)) return [3 /*break*/, 5];
                            return [4 /*yield*/, env.pipe.exec(__spreadArray(__spreadArray([], globalAfterMiddlewares, true), afterMiddlewares, true), ctx, env)];
                        case 4:
                            _b.sent();
                            _b.label = 5;
                        case 5:
...
var UniqueProcessor = /** @class */ (function (_super) {
    ...
    function UniqueProcessor(props) {
        ...
        _this.name = exports.ProcessType.unique;
        _this.interval = 0;
...
var ConfigProcessor = /** @class */ (function (_super) {
    ...
    function ConfigProcessor() {
        ...
        _this.name = exports.ProcessType.config;
        return _this;
    }
 ...
 */
const objectAssignDeepNoMutate = function (...objects) {
...
var RequestProcessor = /** @class */ (function (_super) {
    ...
    function RequestProcessor(props) {
        var _this = _super.call(this) || this;
        _this.name = exports.ProcessType.request;
    ...
    RequestProcessor.prototype.handle = function (ctx, env) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_m) {
                switch (_m.label) {
                    case 0:
                        id = ctx.id, ctxParams = ctx.params, config = ctx.config, service = ctx.service;
                        ...
                        switch ((_a = service === null || service === void 0 ? void 0 : service.default) === null || _a === void 0 ? void 0 : _a.assign) {
                            case 'default':
                                newPath = objectAssignDeep(path, (_b = service === null || service === void 0 ? void 0 : service.default) === null || _b === void 0 ? void 0 : _b.path);
                                newParams = objectAssignDeep(params, (_c = service === null || service === void 0 ? void 0 : service.default) === null || _c === void 0 ? void 0 : _c.params);
                                newData = objectAssignDeep(data, (_d = service === null || service === void 0 ? void 0 : service.default) === null || _d === void 0 ? void 0 : _d.data);
                                break;
                            case 'mixin':
                                newPath = objectAssignDeepNoMutate((_e = service === null || service === void 0 ? void 0 : service.default) === null || _e === void 0 ? void 0 : _e.path, path);
                                newParams = objectAssignDeepNoMutate((_f = service === null || service === void 0 ? void 0 : service.default) === null || _f === void 0 ? void 0 : _f.params, params);
                                newData = objectAssignDeepNoMutate((_g = service === null || service === void 0 ? void 0 : service.default) === null || _g === void 0 ? void 0 : _g.data, data);
                                break;
                            case 'replace':
                            default:
                                newPath = objectAssignDeep((_h = service === null || service === void 0 ? void 0 : service.default) === null || _h === void 0 ? void 0 : _h.path, path);
                                newParams = objectAssignDeep((_j = service === null || service === void 0 ? void 0 : service.default) === null || _j === void 0 ? void 0 : _j.params, params);
                                newData = objectAssignDeep((_k = service === null || service === void 0 ? void 0 : service.default) === null || _k === void 0 ? void 0 : _k.data, data);
                                break;
                        }
                    ...
                    case 3:
                        e_1 = _m.sent();
                        // 收集错误
                        env.emitter.emit(Wrong(exports.ProcessType.request), e_1);
...
var MiddlewareStack = /** @class */ (function () {
    ...
    MiddlewareStack.prototype.getGlobal = function (at) {
        return this.sources.filter(function (mid) { return mid.global === true && mid.at === at; });
    };
...
exports.ProcessorStack = ProcessorStack;
exports.ServiceStack = ServiceStack;
exports.Wrong = Wrong;
exports.WuhaoNetwork = WuhaoNetwork;
